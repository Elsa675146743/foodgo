...
const ProductDetailScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Image du produit */}
            <Image source={require("../../../../assets/images/FriedChicken.png")} style={styles.productImage} />

            {/* Informations */}
            <Text style={styles.title}>Cheeseburger Fried Chicken Burger</Text>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.priceButton}>
                    <Text style={styles.priceText}>$26.99</Text>
                </TouchableOpacity>
